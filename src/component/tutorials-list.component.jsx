...
class TutorialsList extends React.Component {
    ...
    searchTitle() {
        TutorialDataService.searchTitle(this.state.searchTitle).then(response => {
            this.setState({tutorials: response.data});
        }).catch(error => {console.log(error)});
    }
                ...
                <div className="col-md-6">
                    ...
                    <ul className="list-group">
                        {tutorials && tutorials.map((tutorial, index) => (
                            ...
                            } onClick={() => {this.setActiveTutorial(tutorial, index)}} key={index}>{tutorial.title}</li>
                        ))}
                    </ul>
                ...
                <div className="col-md-6">
                    {currentTutorial ? (
                        <React.Fragment>
                            ...
                            <div>
                                <label htmlFor=""><strong>Statur:</strong></label>{" "}
